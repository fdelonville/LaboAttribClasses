    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http, JwtAuthenticationFilter jwtAuthFilter) throws Exception{
        ...
        http.authorizeHttpRequests(
                registry -> registry
                        ...
                        //exercice
                        .requestMatchers("/product/add").hasAnyRole("GERANT","ADMIN")

                        .requestMatchers("/product/all").permitAll()

                        .requestMatchers("/product/add").hasAnyRole("GERANT","ADMIN")

                        .requestMatchers(HttpMethod.DELETE,"/product").hasAnyRole("GERANT","ADMIN")

                        .requestMatchers("/product/*/update").hasRole("ADMIN")

                        .requestMatchers("/store/all").authenticated()

                        .requestMatchers(HttpMethod.DELETE,"/store").hasAnyRole("GERANT","ADMIN")

                        .requestMatchers("/store/*/openings").hasRole("ADMIN")
